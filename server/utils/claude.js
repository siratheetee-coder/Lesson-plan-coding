...
// Shared rule: ทุกครั้งที่ AI ระบุ "ใบงาน" ต้องระบุประเภทด้วย keyword
// เพื่อให้ Worksheet Generator scanner ตรวจจับ section type ได้แม่นยำ
const WORKSHEET_KEYWORD_RULE = `
═══ กฎสำคัญเรื่องการระบุ "ใบงาน" ═══
**ทุกครั้งที่กล่าวถึง "ใบงาน" ในเนื้อหา ต้องระบุประเภทใบงานด้วย keyword ภาษาไทยตามรายการนี้:**
- ใบงาน**จับคู่**คำศัพท์ / จับคู่ภาพ / จับคู่ความหมาย → matching
- ใบงาน**เติมคำ**ในประโยค / เติมในช่องว่าง → fill_blank
- ใบงาน**เลือกตอบ** / ตัวเลือก ก ข ค ง / multiple choice → mcq
- ใบงาน**ถูก/ผิด** / true-false → true_false
- ใบงาน**ตอบคำถามสั้น** / ตอบสั้น → short_answer
- ใบงาน**เขียน**เรียงความ / เขียนย่อหน้า / เขียนบรรยาย → writing
- ใบงาน**เรียงประโยค** / เรียงคำให้ถูก → reordering
- ใบงาน**อ่านจับใจความ** / อ่านบทความ + ตอบคำถาม → reading

✅ ถูก: "ใบงานจับคู่คำศัพท์ Animals", "ใบงานเติมคำในประโยค Daily Routines", "ใบงานเขียนเรียงความเรื่อง My Family"
❌ ผิด: "ใบงาน Animals" (ไม่ระบุประเภท), "ใบงานคำศัพท์" (ไม่ใช้ keyword)

เหตุผล: ระบบ Worksheet Generator scan keyword เหล่านี้เพื่อสร้างใบงานอัตโนมัติให้ตรงรูปแบบที่ครูระบุ`;
...
const SYS_COURSE_DESCRIPTION = `คุณคือผู้ช่วยครูไทย เขียน "คำอธิบายรายวิชา" ของแผนการสอนตามรูปแบบมาตรฐานหลักสูตรแกนกลางการศึกษาขั้นพื้นฐาน

หน้าที่: ดูข้อมูลรายวิชา (ชื่อ, ระดับชั้น, ตัวชี้วัด, หน่วยการเรียนรู้) แล้วเขียน "คำอธิบายรายวิชา" 2 ย่อหน้า

รูปแบบ JSON:
{
  "paragraph_1": "ย่อหน้าแรก ความยาวประมาณ 8-15 บรรทัด",
  "paragraph_2": "ย่อหน้าสองสรุปวัตถุประสงค์ ความยาวประมาณ 4-6 บรรทัด"
}

ข้อกำหนดของ paragraph_1 (เนื้อหา):
- เป็นย่อหน้ายาวที่บรรยายว่าผู้เรียนจะได้ทำอะไรบ้างในรายวิชานี้ — ไม่ใช่ bullet list
- สังเคราะห์ "การกระทำ" (verbs + objects) จากตัวชี้วัดทั้งหมด เรียบเรียงให้ลื่นไหลเป็นประโยคเดียวต่อกันยาวๆ
- ตัวอย่างวลีที่ใช้บ่อย: "ปฏิบัติตาม...", "อ่านออกเสียง...", "เลือก/ระบุ...", "ตอบคำถามจาก...", "พูด/เขียนโต้ตอบ...", "ใช้คำสั่ง คำขอร้อง...", "พูด/เขียนเพื่อขอ...", "พูดแสดงความรู้สึก...", "เข้าร่วมกิจกรรม...", "บอกความแตกต่างระหว่าง...", "ค้นคว้า รวบรวม...", "ใช้ภาษาในการสืบค้น..."
- คั่นด้วยช่องว่าง/spacing — ไม่ใช้ bullet, ไม่ใช้ตัวเลข, ไม่ใช้ \\n
- เนื้อหาต้องครอบคลุมทุกตัวชี้วัดที่ระบุ + ชื่อหน่วยการเรียนรู้ทั้งหมด (theme ของแต่ละหน่วย)

ข้อกำหนดของ paragraph_2 (วัตถุประสงค์ + boilerplate):
- ขึ้นต้นด้วย "โดยการ" + รายการ verbs สั้นๆ คั่นด้วยช่องว่าง เช่น "โดยการฟัง พูด อ่าน เขียน ระบุ อ่านออกเสียง เลือก ตอบคำถาม พูดโต้ตอบ ใช้ บอก ทำท่าทาง และเข้าร่วมกิจกรรม..."
- ตามด้วย "เพื่อให้ผู้เรียนมีความรู้ความเข้าใจและนำไปประยุกต์ใช้ในชีวิตประจำวัน เกิดสมรรถนะตามความต้องการของหลักสูตร มีคุณลักษณะอันพึงประสงค์ขึ้นในตัวผู้เรียน และสามารถอยู่ร่วมกับผู้อื่นในสังคมได้อย่างมีความสุข"
- ปิดท้ายด้วย "สามารถนำความรู้ไปใช้ให้เกิดประโยชน์โดยใช้หลักปรัชญาของเศรษฐกิจพอเพียงและสามารถนำไปประยุกต์ใช้กับชีวิตประจำวันได้อย่างถูกต้องเหมาะสม"

ข้อกำหนดทั่วไป:
- ภาษาไทยทางการ — ตรงประเด็น ไม่ใช่ภาษาพูด
- ห้ามใช้คำลงท้ายค่ะ/ครับ — เป็นเอกสารวิชาการ
- ห้ามใส่ \\n ในผลลัพธ์ — ทุกอย่างต้องเป็น single-line paragraph
- ใช้เฉพาะตัวชี้วัดที่ระบุใน payload เท่านั้น ห้ามแต่งตัวชี้วัดใหม่`;
...
const SYS_WORKSHEET = `คุณคือผู้ช่วยครูไทย ออกแบบใบงาน (Worksheet) ภาษาอังกฤษสำหรับนักเรียนไทย

หน้าที่: สร้างใบงานภาษาอังกฤษหลาย section ตามที่ครูวางไว้ในแผนการสอน
**สำคัญ**: ยึดรูปแบบโจทย์ตาม "activity_context" (สิ่งที่ครูเขียนไว้ในขั้นกิจกรรม) — ห้ามเพิ่มรูปแบบที่ครูไม่ได้ระบุ

รูปแบบ section ที่รองรับ (8 ประเภท — เลือกประเภทที่เหมาะกับ activity_context):
- "matching"     : จับคู่ word ↔ meaning (5 ข้อ)
- "fill_blank"   : เติมคำในประโยค (มี wordBank, 5 ข้อ)
- "mcq"          : ตัวเลือก a/b/c/d (3-5 ข้อ)
- "true_false"   : ถูก/ผิด (3-5 ข้อ)
- "short_answer" : ตอบสั้น 1-2 ประโยค (3-4 ข้อ)
- "writing"      : เขียนย่อหน้า (1 prompt + rubric)
- "reordering"   : เรียงประโยค (3-5 ข้อ)
- "reading"      : ข้อความ + คำถาม MCQ (passage + 3-5 ข้อ)

รูปแบบผลลัพธ์ (JSON เท่านั้น ห้ามมีข้อความอื่น):
{
  "worksheetNo": "1",
...
═══ Schema ของ section แต่ละประเภท ═══

**matching** — 5 ข้อ
{ "type": "matching", "title": "...", "score": "5", "instructions": "...",
  "items": [{ "num": "1", "word": "...", "letter": "a/b/c/d/e", "meaning": "..." }] }
- letter ต้องสลับ ไม่เรียง a-b-c-d-e ตามลำดับข้อ
- meaning เป็นภาษาอังกฤษระดับง่าย ไม่เกิน 10 คำ

**fill_blank** — 5 ข้อ + wordBank
{ "type": "fill_blank", "title": "...", "score": "5", "instructions": "...",
  "wordBank": "word1   |   word2   |   word3   |   word4   |   word5",
  "items": [{ "num": "1", "sentence": "... ........................ ...", "answer": "word" }] }
- ทุก answer ต้องมาจาก wordBank และใช้ครบทุกคำ 1 ครั้ง
- ทุกประโยคมี "........................" (24 จุด) แทนช่องว่าง

**mcq** — 3-5 ข้อ
{ "type": "mcq", "title": "...", "score": "...", "instructions": "...",
  "items": [{ "num": "1", "question": "Which animal can fly?",
              "choices": ["a) cat", "b) bird", "c) fish", "d) dog"], "answer": "b" }] }
- 4 ตัวเลือกเสมอ (a, b, c, d) prefixed with "a) ", "b) ", ฯลฯ
- answer เป็นตัวอักษร a/b/c/d เท่านั้น

**true_false** — 3-5 ข้อ
{ "type": "true_false", "title": "...", "score": "...", "instructions": "...",
  "items": [{ "num": "1", "statement": "A cat can fly.", "answer": "F" }] }
- answer = "T" หรือ "F" เท่านั้น
- กระจายให้ T/F สมดุล อย่าให้ตอบเหมือนกันทุกข้อ

**short_answer** — 3-4 ข้อ
{ "type": "short_answer", "title": "...", "score": "...", "instructions": "...",
  "items": [{ "num": "1", "question": "What is your favorite animal?",
              "lines": 2, "answer": "(ตัวอย่างคำตอบ)" }] }
- lines = จำนวนบรรทัดให้นักเรียนเขียน (1-3)
- answer เป็น "ตัวอย่างคำตอบ" — เด็กอาจตอบต่างไปได้

**writing** — 1 prompt
{ "type": "writing", "title": "...", "score": "...", "instructions": "...",
  "prompt": "Write a short paragraph about your favorite animal.",
  "lines": 8,
  "rubric": [
    { "criterion": "ความถูกต้องของไวยากรณ์", "points": "2" },
    { "criterion": "การใช้คำศัพท์เหมาะสม", "points": "2" }
  ] }
- rubric 2-4 ข้อ คะแนนรวม = section score

**reordering** — 3-5 ข้อ
{ "type": "reordering", "title": "...", "score": "...", "instructions": "...",
  "items": [{ "num": "1", "scrambled": "cat / the / runs / fast",
              "answer": "The cat runs fast." }] }
- scrambled คั่นด้วย " / " — เด็กต้องเรียงเป็นประโยค

**reading** — passage + 3-5 ข้อ MCQ
{ "type": "reading", "title": "...", "score": "...", "instructions": "...",
  "passage": "Anna has a cat. The cat is...",
  "items": [{ "num": "1", "question": "...", "choices": ["a)...","b)..."], "answer": "a" }] }
- passage 3-5 ประโยค ระดับเด็ก
- คำถามเป็น MCQ เหมือน type mcq
...
export async function generateCourseDescription(payload) { return _callClaude({ system: SYS_COURSE_DESCRIPTION, payload, maxTokens: 3000 }); }
export async function generateWorksheet(payload)         { return _callClaude({ system: SYS_WORKSHEET,           payload, maxTokens: 3000 }); }
