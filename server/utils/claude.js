...
- unit_meta: ข้อมูลหน่วย (title, level, total_hours, semester, year)
- lesson_position: { index, total } — แผนปัจจุบันคือแผนที่เท่าไหร่จากทั้งหมดกี่แผนในหน่วย
- prior_lessons: แผนก่อนหน้าที่สอนไปแล้วในหน่วยเดียวกัน (สรุปแบบสั้น — topic, key_concept, vocab, sentences, objectives_brief, activities_outline, task_brief)
- upcoming_lessons: แผนถัดไปที่กำลังจะสอน (ถ้ามี)
